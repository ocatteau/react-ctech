...
import fr.stateofmind.ctech.repository.AuthorityRepository;
...
import fr.stateofmind.ctech.web.rest.errors.ExceptionTranslator;
import fr.stateofmind.ctech.web.rest.vm.KeyAndPasswordVM;
import fr.stateofmind.ctech.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = CtechApp.class)
