...
import fr.stateofmind.ctech.config.audit.AuditEventConverter;
import fr.stateofmind.ctech.domain.PersistentAuditEvent;
...
import static fr.stateofmind.ctech.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
